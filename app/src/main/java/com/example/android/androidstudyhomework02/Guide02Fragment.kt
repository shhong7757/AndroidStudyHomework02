...
class Guide02Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        title.setText(R.string.guide_02_title)
        description.setText(R.string.guide_02_description)
        image.setImageResource(R.drawable.guide_image02)
