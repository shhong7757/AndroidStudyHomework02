...
class Guide01Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        title.setText(R.string.guide_01_title)
        description.setText(R.string.guide_01_description)
        image.setImageResource(R.drawable.guide_image01)
